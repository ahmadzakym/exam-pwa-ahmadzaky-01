...
const FooterV2 = (props) => {
    ...
    return (
        <>
            <div className="footer-section-wrapper flex flex-col justify-center items-center">
                ...
                <Divider className={cx('bg-[#374151]')}/>
                <style jsx global>
                    {`
                        footer.pwa_footer_v2 {
                            background: ${COLORS.primary.footer};
                        }

                        .footer-section-wrapper .footer-links.payment-list {
                            background: ${COLORS.primary.prefooter};
