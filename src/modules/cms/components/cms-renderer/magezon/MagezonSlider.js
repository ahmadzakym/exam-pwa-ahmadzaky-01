                ...
                {owl_nav ? (
                    <div
                        className={cx('flex', 'justify-between', 'pointer-events-none', {
                            ...
                            'magezon-slider--button-nav-wrapper opacity-0 tablet:opacity-100 group-hover:opacity-100 absolute w-full top-[50%] -translate-y-[50%] z-[2]':
                    ...
                    >
                        ...
                        >
                            <ChevronLeft className="w-6 h-6 text-neutral-white hover:text-neutral-white" />
                        </div>
                        <div
                            className={cx(
                                'magezon-slider--button-nav-item',
                        ...
                        >
                            <ChevronRight className="w-6 h-6 text-neutral-white hover:text-neutral-white" />
                        </div>
                    </div>
                ) : null}
